...
const contributions = [
  {
    ...
    description:
      'Corrected a broken documentation link in the Ubuntu project docs, improving developer onboarding experience.',
  ...
  },
  {
    ...
    description:
      'Removed a stale docker-compose.yml file that was no longer maintained and causing confusion for contributors.',
  ...
  },
  {
    ...
    description:
      'Fixed a version detection bug in the Bun installer script and improved user-facing upgrade messages.',
  ...
  },
  {
    ...
    description:
      "Improved clarity of build option descriptions in NumPy's Meson build system for better contributor experience.",
  ...
  },
  {
    ...
    description:
      'Improved the developer setup documentation to reflect current tooling and contribution workflows.',
  ...
  },
  {
    ...
    description:
      "Updated documentation for Slate's scrubber utility with accurate API details and usage examples.",
  ...
  return (
    <section id="opensource" className={styles.container}>
      ...
      <div className={styles.list}>
        {contributions.map((c) => (
          <div key={c.pr} className={styles.entry}>
